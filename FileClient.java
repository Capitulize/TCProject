...
import java.net.*;
    ...
    * @param socket     The initialization of the socket to be able to send request and download.
    * @param socket2    The initialization of the second socket to connect to FileServer and see available files.
    */
